...
import { Search, Crown, PlayCircle, Filter } from "lucide-react";
...
export function Videos() {
  ...
  // Use headers to pass token. If no token, backend might restrict or allow partial view.
            ...
            {videos?.map((video, i) => (
              ...
              >
                <Link href={`/videos/${video.id}`}>
                  <Card className="overflow-hidden glass-card hover:-translate-y-1 hover:border-primary/50 transition-all duration-300 group cursor-pointer h-full flex flex-col">
