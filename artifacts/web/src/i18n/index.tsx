...
const messages: Record<Locale, Record<string, string>> = {
  ar: {
    ...
    "nav.home": "الرئيسية",
    "nav.courses": "الدورات",
    "nav.tools": "مكتبة أدوات GAB",
    "nav.solutions": "الحلول التقنية",
    "nav.community": "مجتمع GAB",
  ...
  fr: {
    ...
    "nav.home": "Accueil",
    "nav.courses": "Cours",
    "nav.tools": "Bibliothèque d’outils GAB",
    "nav.solutions": "Solutions techniques",
    "nav.community": "Communauté GAB",
  ...
  en: {
    ...
    "nav.home": "Home",
    "nav.courses": "Courses",
    "nav.tools": "GAB Tools Library",
    "nav.solutions": "Technical Solutions",
    "nav.community": "GAB Community",
