        ...
        <div className="mt-5">
          ...
          {vipDownload && (
            <a
              ...
              className="download-btn-glow mt-5 flex items-center gap-4 w-full px-5 py-4 rounded-2xl bg-gradient-to-l from-emerald-600 to-green-500 hover:from-emerald-500 hover:to-green-400 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] group"
            >
