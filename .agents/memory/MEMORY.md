...
- [Admin section authorization](admin-section-authorization.md) — Support permissions constrain login landing, navigation, direct routes, and APIs; unknown Admin APIs default to Super Admin.
